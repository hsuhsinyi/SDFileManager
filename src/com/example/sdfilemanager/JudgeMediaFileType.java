...
public class JudgeMediaFileType {  
    ...
    //txt file types
    public static final int FILE_TYPE_TXT	 = 42;
    public static final int FILE_TYPE_APK	 = 43;
    ...
    //根据视频文件路径判断文件类型  
    public static boolean isVideoFileType(File file) {  //自己增加  
    ...
    //根据音频文件判断文件类型  
    public static boolean isAudioFileType(File file) {  
    	String path = file.getPath();
        MediaFileType type = getFileType(path);  
        if(null != type) {  
